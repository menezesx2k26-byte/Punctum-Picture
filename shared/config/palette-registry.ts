...
export const PALETTE_REGISTRY = {
  ...
  "nocturne-plum": {
    id: "nocturne-plum",
    label: "Ameixa noturna",
    description: "Escura, intensa e cinematográfica.",
    mode: "dark",
    colors: {
      background: "#150d1a", surface: "#211528", surfaceSoft: "#34203d",
      foreground: "#fff7fd", muted: "#d2bfd1", primary: "#e1a5ef",
      primaryDeep: "#b56bc8", secondary: "#f0a0c5", accent: "#f3b3d1",
      warmAccent: "#ef9b9b", editorialAccent: "#e9a8c6", mauve: "#a76fba",
      mist: "#43274d", night: "#0e0911", border: "rgba(244, 214, 246, 0.2)",
      onDark: "#fff9ff", onDarkMuted: "rgba(255, 239, 255, 0.78)",
    },
    surfaces: {
      carousel: "radial-gradient(ellipse at 14% 16%, rgba(183, 92, 210, 0.24), transparent 34rem), linear-gradient(145deg, #0f0913 0%, #32143d 54%, #501f43 100%)",
      manifesto: "radial-gradient(circle at 18% 22%, rgba(220, 132, 235, 0.23), transparent 32rem), linear-gradient(135deg, #32123e 0%, #6c285b 100%)",
      contact: "linear-gradient(138deg, #211426 0%, #321b38 54%, #281521 100%)",
      archive: "radial-gradient(ellipse at 86% 10%, rgba(176, 85, 201, 0.2), transparent 34rem), linear-gradient(145deg, #190f1f 0%, #281631 100%)",
      footer: "linear-gradient(128deg, #0f0912 0%, #31143b 50%, #501f43 100%)",
      albumStory: "radial-gradient(ellipse at 10% 15%, rgba(193, 90, 215, 0.23), transparent 34rem), linear-gradient(145deg, #120a17 0%, #3b1747 100%)",
      lightbox: "rgba(8, 5, 10, 0.99)",
    },
  },
  "ink-minimal": {
    id: "ink-minimal",
